    ...
    <div className='w-[72px] h-[1000px] ml-[4px] fixed' >
        <div className='flex items-center flex-col mt-[4px]'>
            ...
            <div className='w-[64px] h-[44px]  mt-[16px] mb-[14px] flex items-center flex-col'>
                ...
                <p className='text-[10px] mt-[5px]'>Home</p>
            </div>
            </Link>
            ...
            <div className='w-[64px] h-[44px]  mt-[16px] mb-[14px] flex items-center flex-col'>
                ...
                <p className='text-[10px] mt-[5px]'>Shorts</p>
            </div>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24" focusable="false" className="pointer-events: none; display: block; width: 100%; height: 100%;"><path d="M10 18v-6l5 3-5 3zm7-15H7v1h10V3zm3 3H4v1h16V6zm2 3H2v12h20V9zM3 10h18v10H3V10z"></path></svg>
                <p className='text-[10px] mt-[5px]'>Subscriptions</p>
            </div>

            <div className='w-[64px] h-[44px]   mt-[16px] mb-[14px] flex items-center flex-col'>
            <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24" focusable="false" className="pointer-events: none; display: block; width: 100%; height: 100%;"><path d="m11 7 6 3.5-6 3.5V7zm7 13H4V6H3v15h15v-1zm3-2H6V3h15v15zM7 17h13V4H7v13z"></path></svg>
                <p className='text-[10px] mt-[5px]'>You</p>
            </div>
        </div>
    </div>
  )
